...
const RestaurantCard = (props) => (
    <div className="col-12 col-sm-6" style={{marginBottom: 20}} >
        <div className="card">
            <div className="card-header">
                <div className="row">
                    <div className="col-12 col-lg-3 text-center">
                        <img className="img-responsive mb-2 mt-1" src={props.restaurant.thumb} style={{borderRadius: 5, maxWidth: 100}} alt="" />
                    </div>
